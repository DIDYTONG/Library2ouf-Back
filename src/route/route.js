...
const {addReadLibrary} = require("../controller/library/addRead");
...
router.post('/library/:id_utilisateur', addLibrary)
...
router.post('/library/:id_library/livre/:id_livre/read', addReadLibrary)
